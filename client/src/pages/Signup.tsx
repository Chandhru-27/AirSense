        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <Card className="border shadow-xl bg-white/80 backdrop-blur-xl" style={{ borderColor: '#DCEBFA', boxShadow: '0 4px 12px rgba(167,199,231,0.25)' }}>
            <CardHeader className="space-y-2 pb-6">
              <CardTitle className="text-2xl font-bold" style={{ color: '#2C3E50' }}>Create an account</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" style={{ color: '#2C3E50' }}>Email address</Label>
                  <Input
                    id="email"
                    type="email"
                    ...
                    style={{ backgroundColor: '#F0F7FF', borderColor: errors.email ? undefined : '#DCEBFA' }}
                  />
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" style={{ color: '#2C3E50' }}>Confirm Password</Label>
                  <Input
                    id="confirmPassword"
                    type="password"
                    placeholder="••••••••"
                    ...
                    style={{ backgroundColor: '#F0F7FF', borderColor: errors.confirmPassword ? undefined : '#DCEBFA' }}
                  />
                ...
                <Button
                  type="submit"
                  className="w-full h-11 text-white font-medium transition-all rounded-xl mt-2"
            ...
            <CardFooter className="justify-center pt-2 pb-6 flex-col gap-2" style={{ borderTop: '1px solid #DCEBFA' }}>
              <p className="text-sm" style={{ color: '#5F7A94' }}>
                ...
                <Link to="/login" className="font-semibold transition-colors" style={{ color: '#89B6E3' }}>
                  Sign in
                </Link>
              </p>
            </CardFooter>
